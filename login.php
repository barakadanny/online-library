                ...
                <div class="contain pt-2">
                  ...
                  <?php endif ?>
                    <div class="mt-5">
                                        ...
                                        <h2>Login to DigiBook</h2>
                        <form action="" method="post" autocomplete="off">
                          <!-- user name here -->
                            <div class="form-group">
                              <label for="exampleInputEmail1">User name or mail <address></address></label>
                              <input autocomplete="off"  type="text" name="user_login_name" class="form-control" id="" placeholder="Name or your address mail" required>
                            </div>
                            <!-- password here -->
                            <div class="form-group">
                            ...
                            <div class="signIn-link">
                                <P>Already an Account? <a href="register.php" >Please Click here to signIn.</a></P>
                            </div>
